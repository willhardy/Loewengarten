# Django settings for loewengarten project.
...
STATIC_ROOT = project_dir('_static')
...
ROOT_URLCONF = 'loewengarten.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'loewengarten.wsgi.application'
